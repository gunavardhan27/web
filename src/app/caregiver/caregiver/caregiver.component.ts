...
import { adhdPresent, autism } from './data';
...
export class CaregiverComponent {
  ...
  learningEnvironmentAdaptations = [
    [
      ...
      `Create color-coded flashcards for key concepts or use highlighters to organize information in textbooks.`
    ],
    [
      "Movement Breaks",
      `Integrate short movement activities between learning sessions to maintain focus and engagement`,
      `Set a timer for 25-minute work periods followed by 5-minute stretch or movement breaks.`
    ],
    [
      "Structured Flexibility",
      `Provide clear guidelines and expectations while allowing room for creative exploration and problem-solving.`,
      `Create a visual schedule with designated "free choice" periods for self-directed learning.`
    ]
  ];
  ...
  nextStepAndResults() {
    ...
    this.mlService.getAdhdResponse(adhd).subscribe({
      next: (response: any) => {
        this.hasADHD = true ? response.prediction === 1 : false;
        if(this.hasADHD){
          this.learningEnvironmentAdaptations = adhdPresent.learningEnvironmentAdaptations
          this.keyStrengths = adhdPresent.keyStrengths
          this.recommendedActivities = adhdPresent.recommendedActivities
          this.learningStylePreferences = adhdPresent.learningStylePreferences
        }
      },
    });
    this.mlService.getAsdResponse(asd).subscribe({
      next: (response) => {
        this.hasASD = true ? response === 1 : false;
        if(this.hasASD){
          this.learningStylePreferences = autism.learningStylePreferences
          this.keyStrengths = autism.keyStrengths
          this.learningEnvironmentAdaptations = autism.learningEnvironmentAdaptations
          this.recommendedActivities = autism.recommendedActivities
        }
      },
    });
    // this.mlService.getDyslexiaResponse(adhd).subscribe({next:(response)=>{
    //   this.hasDyslexia = true ? response === 1 : false
    // }})
    this.goToNextStep();
  }
  ...
  questions = [
    {
      ...
      tooltip:
        'This might include visual details in pictures, subtle sounds, or small changes in routines or environments.',
    },
    {
      id: 2,
      text: 'Does the person have difficulty understanding why someone might be upset',
      tooltip:
        'They may develop deep knowledge or enthusiasm for particular subjects, characters, or activities.',
    },
    {
      id: 3,
      text: 'Does the person have difficulty maintaining a conversation or responding appropriately to questions',
      tooltip:
        'They learn better when information is presented visually through pictures, diagrams, or demonstrations.',
    },
    {
      id: 4,
      text: 'Does the person show little interest in making friends or participating in group activities',
      tooltip:
        'They may notice sensory input more intensely than others or have stronger reactions to sensory stimuli.',
    },
    {
      id: 5,
      text: 'Does the person engage in repetitive behaviors (e.g., hand-flapping, repeating the same phrases)',
      tooltip:
        'They may approach challenges in unusual or creative ways that others might not consider.',
    },
    {
      id: 1,
      ...
      type: 'positive',
      tooltip:
        'Checks if the child responds to their name, an early sign of social awareness.',
    },
    {
      id: 2,
      ...
      type: 'positive',
      tooltip:
        'Assesses how naturally the child maintains eye contact during interactions.',
    },
    {
      id: 3,
    ...
    },
    {
      ...
      type: 'positive',
      tooltip:
        'Looks for social sharing behavior, like pointing out objects of interest.',
    },
    {
      id: 5,
      ...
      type: 'positive',
      tooltip:
        'Assesses imaginative or symbolic play, which reflects social-cognitive development.',
    },
    {
      id: 6,
      ...
      type: 'positive',
      tooltip:
        'Checks joint attention — whether the child follows your gaze or pointing.',
    },
    {
      id: 7,
      ...
      type: 'positive',
      tooltip:
        'Measures empathy or emotional understanding in social situations.',
    },
    {
      id: 8,
    ...
    },
    {
      ...
      type: 'positive',
      tooltip:
        'Checks for non-verbal communication skills like waving or nodding.',
    },
    {
      id: 10,
      ...
      type: 'negative',
      tooltip:
        'Identifies possible signs of social disengagement or lack of awareness.',
    },
  ];
